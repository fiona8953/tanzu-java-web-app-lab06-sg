...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=fiona8953&repo=tanzu-java-web-app-lab06",
  "projectName" : "tanzu-java-web-app-lab06",
  "repositoryPrefix" : "harbor.tap-06.slot-35.tanzu-gss-labs.vmware.com/tap/apps"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->tanzu-java-web-app-l...(truncated)]
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.transformations[0].sources[1].delegate.transformations[2] (ReplaceText)
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->harbor.tap-06.slot-3...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=fiona8953&repo=tanzu-java-web-app-lab06'
